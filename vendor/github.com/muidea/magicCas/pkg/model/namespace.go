...
type Namespace struct {
	...
	Name        string   `json:"name" orm:"name" tag:"view,lite,param"`
	Short       string   `json:"short" orm:"short" tag:"view,lite,param"`
	Description string   `json:"description" orm:"description" tag:"view,param"`
	Status      int      `json:"status" orm:"status" tag:"view,param"`
	Validity    Validity `json:"validity" orm:"validity" tag:"view,param"`
